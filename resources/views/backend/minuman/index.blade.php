                       ...
                       <tr>
                            ...
                            <td>
                                    ...
                                    <img width="100px" height="100px" 
                                     src ="{{asset('assets/img/minuman/'.
                                     $data->foto.'') }}" alt="foto">
                                </td>
                            
                            <td>
                                <a href="{{ route('minuman.edit',$data->id) }}" class="btn btn-sm btn-success"><i class="nc-icon nc-refresh-69"></i></a>
      ...
      <div class="modal-body">
            <form action="{{ route('minuman.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group"> 
                        ...
                        <input type="text" name="minuman" id="" class="form-control"  aria-describedby="helpId">
                    </div>
