...
<head>
  ...
  <link href="/backend/NiceAdmin/css/font-awesome.css" rel="stylesheet" />
  <!-- Custom styles -->
    ...
    <form class="login-form" action="{{ route('login') }}" method="POST">
      ...
      <div class="login-wrap">
        ...
        <div class="input-group">
          ...
          <input type="email" class="form-control @error('email') is-invalid @enderror" value="{{ old('email') }}" name="email" id="email" placeholder="Email" autofocus>
                @error('email')
